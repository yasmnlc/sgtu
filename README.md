...
* **Prototipação de Interface (Figma):** [Link do seu projeto no Figma]
* **Gestão do Projeto & Sprint Planning (Trello/GitHub Projects):** [Link do seu Board]
* **Slides de Apresentação da Proposta (Canva):** [Link dos slides criados para a Secretaria]
...
## 📅 Planejamento das Sprints (Entrega 1)

### Meta da Sprint 1 (Foco: Concepção e Requisitos)
* Mapeamento do domínio e validação informal da proposta com o cliente (Secretaria de Educação de Boa Viagem).
* Elaboração do Documento de Requisitos e especificação das primeiras Histórias de Usuário.
* Criação do protótipo das principais telas e fluxo de navegação.
* Estruturação e configuração do repositório Git público.
